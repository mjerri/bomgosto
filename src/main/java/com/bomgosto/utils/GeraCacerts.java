...
public class GeraCacerts {
    ...
    public static void main(String[] args) {
        //GeraCacerts.main(args, "C:\\dev\\nfe\\cacerts\\cacerts-prod", 1);
        GeraCacerts.main(args, "C:\\dev\\nfe\\cacerts\\cacerts-hom", 2);
    }

    public static void main(String[] args, String path, int ambient) {
        try {
            // Senha padrao "chanegit", se alterada, sera necessario informar a senha toda vez que o arquivo cacerts for utilizado para conexao.
            ...
            if (ambient == 1) {
                // Link nao testado
                //get("nfce.sefaz.mt.gov.br", 443, ks);
                get("nfe.sefaz.mt.gov.br", 443, ks);
            } else {
                // Homologacao
                // Gerando apenas para o estado de Mato Grosso
...
//                get("homologacao.nfe.sefazvirtual.rs.gov.br", 443, ks);
            ...
            File cafile = new File(path == null ? JSSECACERTS : path);
    ...
    public static void get(String host, int port, KeyStore ks) throws Exception {
        ...
        GeraCacerts.SavingTrustManager tm = new GeraCacerts.SavingTrustManager(defaultTrustManager);
